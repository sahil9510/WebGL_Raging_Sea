...
gui.add(waterMaterial.uniforms.uSmallIterations,'value').min(0).max(5).step(1).name('uSmallWavesIterations');
...
gui
    ...
    .onChange(()=>{
        waterMaterial.uniforms.uSurfaceColor.value.set(debugObject.depthColor)})
